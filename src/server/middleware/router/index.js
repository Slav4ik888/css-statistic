...
// USERS - Data
router.get (Path.User.LOAD_START_RES, FBAuth, us.getStartResourses);
router.get (Path.User.GET_USER,       FBAuth, us.getUser);
router.post(Path.User.UPDATE_USER,    FBAuth, us.updateUser);
