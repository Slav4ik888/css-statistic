...
// console.log(`mailer.user: `, mailer.user);
// console.log(`mailer.password: `, mailer.password);

// import { loggerMail } from '../loggers/index.js';
// loggerMail.info(`[sendMail] - mailer.user: ${mailer.user} mailer.password: ${mailer.password}`)
